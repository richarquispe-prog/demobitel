...
import image4 from '../../../assets/images/faces/2.jpg';
import image5 from '../../../assets/images/faces/3.jpg';
import image6 from '../../../assets/images/faces/4.jpg';

export const Aboutusdata1 = [
    {
        id: 1,
        bgColor: 'primary',
        iconPath: (<svg className="about-icons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="#0162e8" d="M10.3125,16.09375a.99676.99676,0,0,1-.707-.293L6.793,12.98828A.99989.99989,0,0,1,8.207,11.57422l2.10547,2.10547L15.793,8.19922A.99989.99989,0,0,1,17.207,9.61328l-6.1875,6.1875A.99676.99676,0,0,1,10.3125,16.09375Z" opacity=".99" /><path fill="#367cdd" d="M12,2A10,10,0,1,0,22,12,10.01146,10.01146,0,0,0,12,2Zm5.207,7.61328-6.1875,6.1875a.99963.99963,0,0,1-1.41406,0L6.793,12.98828A.99989.99989,0,0,1,8.207,11.57422l2.10547,2.10547L15.793,8.19922A.99989.99989,0,0,1,17.207,9.61328Z" /></svg>),
        counter: '256',
    ...
    },
    {
        ...
        counter: '153',
        label: 'Awards Won',
        counterColor: 'text-info'
    }
]

export const Aboutusdata2 = [
    { id: 1, imageSrc: image3, name: 'Rosen Berg', position: 'Chief Manager', },
    { id: 2, imageSrc: image4, name: 'Mclaren Mcannen', position: 'Sales Manager', },
    { id: 3, imageSrc: image5, name: 'Shimpa Craig', position: 'Author & Writer', },
    { id: 4, imageSrc: image6, name: 'Limo Peter', position: 'Operations Head', }
]