                        ...
                        <Card.Body>
                            ...
                            <div className="card-body pb-0">
                                ...
                                <p className="card-text">
                                    <Link to="#" className="stretched-link text-danger" style={{ position: 'relative' }}>
                    ...
                    <Card className="custom-card">
                        ...
                        <Card.Body>
                            <div className="bg-light clearfix">
                                <Button type="button" className="btn btn-primary float-start mb-2 mb-sm-0">Example Button floated left</Button>
                                <Button type="button" className="btn btn-primary float-end">Example Button floated right</Button>
                            </div>
                        </Card.Body>
                    </Card>
                </Col>
