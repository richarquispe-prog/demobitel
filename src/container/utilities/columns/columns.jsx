                                ...
                                <Card.Body className="bd-example-row bd-example-row-flex-cols">
                                    <div className="container">
                                        {Verticaldata.map((idx) => (
                                            <div className={`row align-items-${idx.class} mb-3`} key={idx.id}>
                                                <div className="col">
                                ...
                                <Card.Body className="bd-example-row">
                                    ...
                                    <div className="container">
                                        <div className="row mb-3">
                                            ...
                                            <Col md={4} className="col-md-4 ms-auto">.col-md-4 .ms-auto</Col>
                                        </div>
                                        <div className="row mb-3">
                                            <Col md={3} className="col-md-3 ms-md-auto">.col-md-3 .ms-md-auto</Col>
                                            <Col md={3} className="col-md-3 ms-md-auto">.col-md-3 .ms-md-auto</Col>
                                        </div>
                                        <Row>
                                ...
                                <Card.Body className="bd-example-row">
                                    <div className="container">
                                        {Horizontaldata.map((idx) => (
                                            <div className={`row justify-content-${idx.class}`} key={idx.id}>
                                                <div className="col-4">
                                                    One of two columns
                                                </div>
                                                <div className="col-4">
                    ...
                    <Card className="custom-card">
                        ...
                        <Card.Body className="bd-example-row">
                            <div className="container mb-3">
                                <Row className="mb-3">
                                    <Col md={4}>.col-md-4</Col>
                                    <Col md={4} className="col-md-4 offset-md-4">.col-md-4 .offset-md-4
                                    </Col>
                                </Row>
                                <Row className="mb-3">
                                    <Col md={3} className="col-md-3 offset-md-3">.col-md-3 .offset-md-3
                                    </Col>
                                    <Col md={3} className="col-md-3 offset-md-3">.col-md-3 .offset-md-3
                                    </Col>
                                </Row>
                                <Row>
                                    <Col md={6} className="col-md-6 offset-md-3">.col-md-6 .offset-md-3
                                    </Col>
                                </Row>
                            </div>
                            ...
                            <div className="container">
                                <div className="row mb-3">
                                    ...
                                    <Col sm={5} md={6} className="col-sm-5 offset-sm-2 col-md-6 offset-md-0">
                                        .col-sm-5
                                ...
                                <Row>
                                    <Col sm={6} md={5} lg={6}>.col-sm-6 .col-md-5
                                        .col-lg-6</Col>
                                    <Col sm={6} md={5} lg={6} className="col-sm-6 col-md-5 offset-md-2 col-lg-6 offset-lg-0">
                                        .col-sm-6
