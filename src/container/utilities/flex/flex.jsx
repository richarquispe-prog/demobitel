                ...
                <Col xl={6}>
                    <Card className="custom-card">
                        ...
                        <Card.Body>
                            <div className="bd-example flex-container mb-3">
                                {Contentdata.map((idx) => (
                                    <div className={`d-flex justify-content-${idx.class} mb-3`} key={idx.id}>
                        ...
                        <Card.Body>
                            <div className="bd-example flex-container mb-3">
                                {Contentdata1.map((idx) => (
                                    <div className={`d-flex align-items-${idx.class}`} style={{ height: 100 }} key={idx.id}>
                                        <div className="p-2">Flex item</div>
                                        <div className="p-2">Flex item</div>
                                        <div className="p-2">Flex item</div>
                                    </div>
                        ...
                        <Card.Body>
                            <div className="bd-example flex-container mb-3">
                                {Contentdata3.map((idx) => (
                                    <div className="d-flex mb-3" style={{ height: 100 }} key={idx.id}>
                                        <div className="p-2">Flex item</div>
                                ...
                                <Card.Body>
                                    <div className="bd-example flex-container mb-3">
                                        {Contentdata4.map((idx) => (
                                            <div className={`d-flex align-content-${idx.class} flex-wrap mb-3`} style={{ height: 200 }} key={idx.id}>
                                                <div className="p-2">Flex item</div>
                                                <div className="p-2">Flex item</div>
                                                <div className="p-2">Flex item</div>
                                                <div className="p-2">Flex item</div>
